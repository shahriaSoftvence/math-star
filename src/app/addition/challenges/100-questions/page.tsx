        ...
        <div className="w-full max-w-[672px] p-8 bg-white rounded-3xl shadow-lg flex flex-col items-center text-center gap-6">
            ...
            <div>
                ...
                <p className="text-gray-600 mt-2 text-base font-normal font-Nunito leading-normal">
                    Solve as many problems as you can in 5 minutes!
                </p>
            </div>
        ...
        <div className="grid grid-cols-3 gap-2 w-full max-w-xs">
            {['1', '2', '3', '4', '5', '6', '7', '8', '9'].map((num) => (
                <button
                    ...
                    className="h-14 bg-blue-100 rounded flex items-center justify-center text-blue-800 text-lg font-bold font-Nunito hover:bg-blue-200 transition-colors"
                >
                    {num}
                </button>
            ))}
            <button
                ...
                className="h-14 bg-blue-100 rounded flex items-center justify-center text-blue-800 text-lg font-bold font-Nunito hover:bg-blue-200 transition-colors col-span-2"
            >
                0
            </button>
            <button
            ...
            <button
                ...
                className="h-14 bg-green-100 rounded flex items-center justify-center text-green-800 text-lg font-bold font-Nunito hover:bg-green-200 transition-colors col-span-2"
            >
                ✓
            </button>
        </div>
...
const QuestionsGrid = ({ questions, questionStatuses }: { questions: Question[], questionStatuses: ProgressStatus[] }) => {
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow-md">
            <h3 className="text-center text-gray-800 text-xl font-bold font-Nunito leading-7 mb-2">Solve all 100 problems</h3>
            <div className="flex justify-center items-center gap-4 mb-4">
                <div className="flex items-center"><div className="w-4 h-4 bg-yellow-300 rounded mr-2"></div><span className="text-sm font-Nunito">Current</span></div>
                <div className="flex items-center"><div className="w-4 h-4 bg-green-400 rounded mr-2"></div><span className="text-sm font-Nunito">Correct</span></div>
                <div className="flex items-center"><div className="w-4 h-4 bg-red-400 rounded mr-2"></div><span className="text-sm font-Nunito">Wrong</span></div>
            </div>
...
export default function HundredQuestionsPage() {
    ...
    if (isComplete) {
        return <CongratulationsScreen onContinue={() => router.push('/addition')} rewardName="Challenge Crusher" />;
    }
