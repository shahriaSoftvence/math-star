...
export default function WhatsMissingPage() {
  ...
  const getQuestionString = () => {
    ...
    if (missingIndex === 0) return `${missingPlaceholder} x ${num2} = ${answer}`;
    if (missingIndex === 1) return `${num1} x ${missingPlaceholder} = ${answer}`;
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-green-50 to-purple-50 p-6">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex justify-between items-center">
            <div className="flex flex-col">
              ...
              <span className="text-green-600 text-4xl font-bold font-Nunito leading-tight">{score + 1}</span>
            </div>
            <div className="flex flex-col">
