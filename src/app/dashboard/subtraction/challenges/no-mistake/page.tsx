    ...
    <div className="grid grid-cols-3 gap-4 w-72">
      {buttons.map((btn) => (
        <button
          ...
          className="h-16 text-3xl font-bold text-pink-800 bg-pink-100 rounded-2xl transition-colors hover:bg-pink-200"
        >
          {btn}
        </button>
      ))}
        ...
        <div className="flex flex-col justify-start items-start mb-12 gap-2 md:mb-16">
          ...
          <div className="flex items-start gap-4 md:gap-6">
            <div className="p-3 bg-blue-100 rounded-full flex justify-center items-center">
              <Target className="w-7 md:w-10 h-7 md:h-10 text-pink-600" />
            </div>
