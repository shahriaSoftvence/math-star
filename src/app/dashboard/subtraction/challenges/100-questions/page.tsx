...
export default function HundredQuestionsPage() {
    ...
    const [addSubtraction100Question, { isLoading: isSaving }] = useAddSubtraction100QuestionMutation();
    ...
    const handleContinue = async () => {
        try {
            ...
            toast.error(api_results?.practice_saved);
            router.push("/dashboard/subtraction");
        }
    };
        ...
        <div className='bg-gradient-to-b from-pink-50 to-purple-50 p-4'>
            <div className="max-w-[1440px] mx-auto min-h-screen">
                ...
                <div className="flex flex-col xl:flex-row justify-center items-center gap-6">
                    {/* Left Side: Timer */}
                    <div className="w-56 h-56 md:w-64 md:h-64 bg-gradient-to-br from-pink-400 to-pink-500 rounded-full flex flex-col justify-center items-center flex-shrink-0">
