...
export default function HundredQuestionsPage() {
    ...
    const [timeLeft, setTimeLeft] = useState(600); // 10 minutes for division
    ...
    if (isComplete) {
        return <CongratulationsScreen onContinue={() => router.push('/division')} rewardName="Challenge Crusher" />;
    }
