    ...
    <div className="w-full min-h-screen relative bg-gradient-to-b from-purple-50 to-indigo-50 flex flex-col justify-center items-center p-4">
        <div className="w-full max-w-md p-8 bg-white rounded-3xl shadow-lg flex flex-col items-center text-center gap-4 min-w-[672px] mx-auto">
            ...
            <div className="w-full mt-4 flex justify-center items-center gap-4">
                <button onClick={onRetry} className="flex-1 py-2.5 bg-purple-500 text-slate-50 rounded-md font-medium text-sm leading-tight hover:bg-purple-600 transition-colors">Play Again</button>
   ...
   return (
    <div className="w-full min-h-screen bg-gradient-to-b from-purple-50 to-indigo-50 p-4 md:p-6">
        <div className="flex items-start gap-4 md:gap-6 mb-12 md:mb-16">
            <div className="w-24 h-24 bg-purple-100 rounded-full flex justify-center items-center">
                ...
                <div className="w-full md:w-[400px] lg:w-[569px] flex flex-col gap-4 md:gap-5">
                    <div className="self-stretch flex justify-between items-center">
                        <div className="h-20 flex flex-col">
                            ...
                            <span className="text-purple-600 text-4xl font-bold font-Nunito leading-loose">{score + 1}</span>
                        </div>
                        <div className="h-20 flex flex-col">
