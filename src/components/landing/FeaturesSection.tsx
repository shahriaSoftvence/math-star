...
const featureData = [
  {
    ...
    content: "Math Star is an e-learning platform created by experienced elementary school teachers. We all share a common goal of helping children learn.",
    footer: "It's our passion!",
  },
  {
    title: 'Basic Math Operations',
    content: "We are committed to helping children improve their skills in the four basic math operations:",
    list: ['Addition', 'Subtraction', 'Multiplication', 'Division'],
  },
  {
    title: 'Personalized Learning',
    content: "Children can create exercises tailored to their needs at their personal learning pace - quick and easy.",
    footer: "Never repetitive, thanks to adaptive exercise generation.",
  },
  {
    title: 'Safe Learning Environment',
    content: "Math Star is free from ads, games and other distractions. We don't provide tools to communicate or connect with other users.",
  ...
  <div className="flex-1 h-96 relative bg-gradient-to-br from-blue-400 to-blue-500 rounded-2xl shadow-lg p-8 text-white flex flex-col">
    ...
    {list && (
      <ul className="mt-4 space-y-2">
        {list.map(item => <li key={item} className="text-blue-100 text-base font-normal font-sans leading-normal">• {item}</li>)}
      </ul>
    )}
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center gap-16">
        <div className="text-center max-w-3xl">
          ...
          <p className="text-gray-600 text-xl font-normal font-sans leading-7 mt-4">
            Our special features that make your child's learning more effective and enjoyable
          </p>
        </div>
