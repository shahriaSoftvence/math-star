...
const authApi = baseApi.injectEndpoints({
    endpoints: (builder) => ({
        ...
        changePassword: builder.mutation({
            query: (passwordData: { old_password: string; new_password: string; confirm_password: string }) => ({
                url: '/change-password/',
                method: 'PUT',
                body: passwordData,
            }),
        ...
        changePasswordWithResetToken: builder.mutation({
            query: (data: { reset_token: string; email: string; new_password: string; confirm_password: string }) => ({
